    ...
    <div className="policy-page-container">
      ...
      <div className="policy-page-card">
        <section className="policy-section">
          ...
          <div className="cookie-table-wrapper" style={{ marginTop: "1.25rem" }}>
            <table className="cookie-table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>HTTP Cookie</td>
                  <td><span className="cookie-badge essential">Essential</span></td>
                  <td>Base64-encoded user identity claims (username and email) read by React UI state hooks. Secure.</td>
                  <td>14 Days</td>
                </tr>
                <tr>
