    ...
    IConfiguration configuration)
{
    public void ExtractSentences()
    {
        ...
        foreach (var resource in vocabulary)
        {
            var sentences = resource.Object == SubjectType.Vocabulary.ToSnakeCaseString()
                ? GetSentence(resource as DataAccess.Models.Vocabulary)
                : GetSentence(resource as DataAccess.Models.Vocabulary);
    ...
    private List<(string Ja, string En, int Level, SubjectReference Source)> GetSentence(DataAccess.Models.Vocabulary vocab)
    {
