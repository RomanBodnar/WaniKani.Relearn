...
public partial class RadicalMapper
{
    ...
    [MapProperty(nameof(SingleResource<>.Data) + "." + nameof(Radical.LessonPosition), nameof(Models.Radical.LessonPosition))]
    [MapProperty(nameof(SingleResource<>.Data) + "." + nameof(Radical.Level), nameof(Models.Radical.Level))]
