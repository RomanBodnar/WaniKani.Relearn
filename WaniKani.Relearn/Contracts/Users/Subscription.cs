...
public record Subscription
{
    ...
    /// For unsubscribed/free users, the maximum level is 3. 
    /// For subscribed users, this is 60. Any application that uses data from the WaniKani API must respect these access limits.
    /// </summary>
