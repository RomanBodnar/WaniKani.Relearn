...
public class RelearnDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<VocabularyPronunciationAudioEntity>(b =>
        {
            ...
            b.Property(vpa => vpa.VoiceActorId).HasColumnName("voice_actor_id").HasMaxLength(100).IsRequired();
            b.Property(vpa => vpa.VoiceActorName).HasColumnName("voice_actor_name").HasMaxLength(255).IsRequired();
